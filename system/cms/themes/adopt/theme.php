...
class Theme_Adopt extends Theme {

    public $name			= 'Adopt - Admin Theme';
    public $author			= 'Don Gilbert';
    public $author_website	= 'http://www.electriceasel.com/';
    public $website			= 'http://www.electriceasel.com/';
    public $description		= 'Custom PyroCMS admin theme. HTML5 and CSS3 styling.';
